...
class LatentDiffusion(DDPM):
    ...
    def configure_optimizers(self):
        ...
        params = list(self.model.parameters())
        #! 添加vae网络学习
        first_stage_params = list(self.first_stage_model.parameters())
        if self.cond_stage_trainable:
        ...
        #! 使用不同的学习率
        param_groups = [
        {'params': params, 'lr': lr},           # 主网络，lr
        {'params': first_stage_params, 'lr': lr/2},  # first_stage，lr 一半
        ]
