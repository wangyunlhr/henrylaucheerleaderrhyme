...
if __name__ == "__main__":
    ...
    try:
        ...
        for k in nondefault_trainer_args(opt): #! 命令行替换了部分trainer_config参数
        ...
        num_workers = getattr(config.data.params, "num_workers", config.data.params.batch_size)
        ...
        print("#### Data #####")
        print(f"train, {type(data.train_dataset).__name__}, {len(data.train_dataset)}")
        print(f"val, {type(data.val_dataset).__name__}, {len(data.val_dataset)}")
